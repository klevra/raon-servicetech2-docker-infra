#!/usr/bin/env bash
# ============================================================================
# JDK21 실행 베이스 이미지 빌드 + servicetech2 레지스트리 push 스크립트 (bash)
#
# 지원 환경 : Linux / macOS / Windows(Git Bash, WSL)
# 대상      : OmnioneCX v2의 verifier/oacx/admin 등 JDK21 애플리케이션
# ============================================================================
set -uo pipefail
...
echo "=============================================================="
echo " JDK21 실행 베이스 이미지 빌드 + servicetech2 레지스트리 등록"
echo "=============================================================="
...
echo
echo "베이스로 사용할 eclipse-temurin JDK21 이미지 태그를 선택하세요:"
echo "  1) 21-jre         (Debian 기반, 기본값)"
echo "  2) 21-jre-alpine   (경량, Alpine 기반)"
ask "번호 선택" "1"
case "$REPLY" in
  1) UPSTREAM_IMAGE="eclipse-temurin:21-jre"; TAG="latest" ;;
  2) UPSTREAM_IMAGE="eclipse-temurin:21-jre-alpine"; TAG="alpine" ;;
