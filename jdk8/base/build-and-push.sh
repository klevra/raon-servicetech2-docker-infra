#!/usr/bin/env bash
# ============================================================================
# JDK8 실행 베이스 이미지 빌드 + servicetech2 레지스트리 push 스크립트 (bash)
#
# 지원 환경 : Linux / macOS / Windows(Git Bash, WSL)
# 대상      : v1의 verifier 등 "JAR 하나만 실행하면 되는" JDK8 애플리케이션
# ============================================================================
set -uo pipefail
...
echo "=============================================================="
echo " JDK8 실행 베이스 이미지 빌드 + servicetech2 레지스트리 등록"
echo "=============================================================="
...
echo
echo "베이스로 사용할 eclipse-temurin JDK8 이미지 태그를 선택하세요:"
echo "  1) 8-jre         (Debian 기반, 기본값)"
echo "  2) 8-jre-alpine   (경량, Alpine 기반)"
ask "번호 선택" "1"
case "$REPLY" in
  1) UPSTREAM_IMAGE="eclipse-temurin:8-jre"; TAG="latest" ;;
  2) UPSTREAM_IMAGE="eclipse-temurin:8-jre-alpine"; TAG="alpine" ;;
