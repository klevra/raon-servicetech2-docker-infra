#!/usr/bin/env bash
# ============================================================================
# OmnioneCX oacx — 우리투자증권(wooriib) 전용 이미지(1.0.0.9) 빌드 + push
#
...
IMAGE_KIND="omnionecx-oacx-wooriib"
VERSION="1.0.0.9"   # 이 사이트에 고정된 OACX 버전
...
echo "=============================================================="
echo " OmnioneCX oacx (우리투자증권/wooriib) ${VERSION} 이미지 빌드 + 레지스트리 등록"
echo "=============================================================="
