# omnionecx — 우리투자증권 (wooriib)

- 사이트 코드: `wooriib`
- OACX 버전: `1.0.0.9`
- verifier 버전: `1.3.25_fix`
...
verifier/ -- Dockerfile + build-and-push.sh (verifier 1.3.25_fix 산출물 빌트인)
oacx/     -- Dockerfile + build-and-push.sh (OACX 1.0.0.9 산출물 빌트인)
