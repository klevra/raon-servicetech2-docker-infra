<#
.SYNOPSIS
  OmnioneCX 통합 배포 스크립트 (PowerShell) — 백포팅 트랙 (aia, 2.0.0.1)
...
.DESCRIPTION
  ...
  스크립트도 2.0.0.3 deploy.ps1을 그대로 재사용한 것이다.
...
$VerifierAppVersion = "1.3.36_fix"
$OacxAppVersion = "2.0.0.1"
$AdminAppVersion = "2.0.0.1"
...
Write-Host "=============================================================="
Write-Host " OmnioneCX $Site 통합 배포 (백포팅 트랙, 태그=$MovingTag)"
...
$ComposeProject = Ask "docker compose 프로젝트 이름" "omnionecx-aia"
...
Write-Info "aia(2.0.0.1) oacx도 2.0.0.3과 동일하게 co*-provider.json 같은 인증사업자별 설정 파일이 없어(내장 mid.providers 고정 목록 사용), 1.0.0.12의 provider.json/DID publicKey 반영 단계는 이 트랙에 해당 사항이 없습니다."
