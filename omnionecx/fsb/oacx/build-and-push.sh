#!/usr/bin/env bash
# ============================================================================
# OmnioneCX oacx — 저축은행중앙회(fsb) 전용 이미지(1.0.0.3) 빌드 + push
#
...
IMAGE_KIND="omnionecx-oacx-fsb"
VERSION="1.0.0.3"   # 이 사이트에 고정된 OACX 버전
...
echo "=============================================================="
echo " OmnioneCX oacx (저축은행중앙회/fsb) ${VERSION} 이미지 빌드 + 레지스트리 등록"
echo "=============================================================="
