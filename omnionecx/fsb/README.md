# omnionecx — 저축은행중앙회 (fsb)

- 사이트 코드: `fsb`
- OACX 버전: `1.0.0.3`
- verifier 버전: `1.3.19_fix`
...
verifier/ -- Dockerfile + build-and-push.sh (verifier 1.3.19_fix 산출물 빌트인)
oacx/     -- Dockerfile + build-and-push.sh (OACX 1.0.0.3 산출물 빌트인)
