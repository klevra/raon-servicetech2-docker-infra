#!/usr/bin/env bash
# ============================================================================
# OmnioneCX verifier — 저축은행중앙회(fsb) 전용 이미지(1.3.19_fix) 빌드 + push
#
# 전제조건: 이 스크립트와 같은 위치의 app/ 안에 실제 verifier 실행 산출물
#           (mdl-verifier-1.3.19-fix.jar, jdbc/ 등)이 있어야 한다. app/은
...
IMAGE_KIND="omnionecx-verifier-fsb"
VERSION="1.3.19_fix"   # 이 사이트에 고정된 verifier 버전
...
echo "=============================================================="
echo " OmnioneCX verifier (저축은행중앙회/fsb) ${VERSION} 이미지 빌드 + 레지스트리 등록"
echo "=============================================================="
