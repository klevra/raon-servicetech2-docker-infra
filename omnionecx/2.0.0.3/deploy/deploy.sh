#!/usr/bin/env bash
# ============================================================================
# OmnioneCX 통합 배포 스크립트 (bash) — 버전 고정 이미지 트랙 (2.0.0.3)
#
...
VERIFIER_APP_VERSION="1.3.42-springboot-3"
OACX_APP_VERSION="2.0.3"
ADMIN_APP_VERSION="2.0.3"
...
ask "docker compose 프로젝트 이름" "omnionecx-2003"
...
info "2.0.0.3 oacx는 co*-provider.json 같은 인증사업자별 설정 파일이 없어(내장 mid.providers 고정 목록 사용), 1.0.0.12의 provider.json/DID publicKey 반영 단계는 이 트랙에 해당 사항이 없습니다."
