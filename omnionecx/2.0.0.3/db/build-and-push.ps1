<#
.SYNOPSIS
  OmnioneCX DB — OmnioneCX 2.0.0.3 트랙 전용 이미지 빌드 + push (PowerShell)
...
# ============================================================================
Write-Host ""
$SiteTag = Ask "사이트 코드 (이동 태그로 사용 -- 이 트랙이 현재 쓰는 이미지를 가리킴)" $DefaultSiteTag
...
if ($Version -ne $SiteTag) {
    Write-Host "              : $MovingImage (이동 태그, 이 트랙이 현재 쓰는 이미지)"
}
Write-Host "==========================================================="
