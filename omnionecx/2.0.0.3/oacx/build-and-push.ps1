<#
.SYNOPSIS
  OmnioneCX oacx — OmnioneCX 2.0.0.3 트랙 전용 이미지 빌드 + push (PowerShell)
...
.DESCRIPTION
  ...
  대상 베이스: jdk21/base로 이미 레지스트리에 등록된 servicetech2/jdk21 이미지
            (1.0.0.12는 tomcat9-jdk8+WAR였지만, 이 oacx는 내장 Tomcat 포함
            Boot3 fat jar라 jdk21을 쓴다).

  주의: site-tag는 1.0.0.12가 이미 "latest"를 전용으로 쓰고 있어서
  2.0.0.3 트랙은 별도의 고정 이동 태그("2.0.0.3")를 쓴다 -- latest와 충돌 금지.
#>
